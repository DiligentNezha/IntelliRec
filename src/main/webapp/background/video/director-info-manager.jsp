...
<head>
    ...
    <meta name="description" content="导演信息管理">
    <title>导演信息管理</title>
    ...
    <script>
        ...
        $(function () {
            var  columns = [{filed:'id', title:'导演编号'},
                {filed:'directorName', title:'导演名称'},
                {filed:'description', title:'导演描述'}];
            var table = $('#bg_director_videotable');
            var pager = $('#bg_director_pager');
            var baseUrl = '${pageContext.request.contextPath}/videoManager/DirectorManagerAction!';
            getDataFromServer(table, baseUrl + 'tableData', null, columns, pager);
            <%--getDataFromServer(table, '${pageContext.request.contextPath}/videoManager/videoManagerAction!tableData',--%>
            <%--null, columns, pager);--%>

            changeRows = function (rows) {
                $('#bg_director_tablerowsselect').html(rows + '&nbsp;&nbsp;<span class="caret"></span>');
            ...
            getParams = function () {
                var rowsNumber = $.trim($('#bg_director_tablerowsselect').text());
                var inputs = $('#bg_director_search input');
                // TODO update params
...
<div id="content" class="pmd-content inner-page">
    ...
    <div class="container-fluid full-width-container value-added-detail-page">
        <!-- Search -->
        <div>
            <div id="bg_director_search" class="pull-right table-title-top-action">
                <div class="row">
                    <div class="col-sm-5">
            ...
            <ol class="breadcrumb text-left">
                <li><a href="index.html">导演模块</a></li>
                <li class="active">导演信息管理</li>
            </ol><!--breadcrum end-->
        </div>
        <!-- Table -->
        <div class="table-responsive pmd-card pmd-z-depth">
            <table id="bg_director_videotable" class="table table-mc-red pmd-table">

            </table>
        </div>
        <!-- Card Footer -->
        <div id="bg_director_pager" style="display: none;" class="pmd-card-footer">
            <ul class="pmd-pagination pull-right list-inline">
			  ...
			  <button class="btn pmd-ripple-effect pmd-btn-flat btn-link dropdown-toggle" type="button"
                      id="bg_director_tablerowsselect" data-toggle="dropdown" aria-expanded="false">10 <span
