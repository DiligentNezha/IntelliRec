...
<head>
    ...
    <meta name="description" content="视频信息管理">
    <title>视频信息管理</title>
    ...
    <script>
        ...
        $(function () {
            var  columns = [{filed:'id', title:'视频编号'},
                {filed:'videoName', title:'视频名称'},
                {filed:'published', title:'上映日期'},
                {filed:'alias', title:'电影别名'}];
            var table = $('#bg_video_videotable');
            var pager = $('#bg_video_pager');
            var baseUrl = '${pageContext.request.contextPath}/videoManager/videoManagerAction!';
            ...
            changeRows = function (rows) {
                $('#bg_video_tablerowsselect').html(rows + '&nbsp;&nbsp;<span class="caret"></span>');
            ...
            getParams = function () {
                var rowsNumber = $.trim($('#bg_video_tablerowsselect').text());
                var inputs = $('#bg_video_search input');
                // TODO update params
...
<div id="content" class="pmd-content inner-page">
    ...
    <div class="container-fluid full-width-container value-added-detail-page">
        <!-- Search -->
        <div>
            <div id="bg_video_search" class="pull-right table-title-top-action">
                <div class="row">
                    <div class="col-sm-5">
            ...
            <ol class="breadcrumb text-left">
                <li><a href="index.html">视频模块</a></li>
                <li class="active">视频信息管理</li>
            </ol><!--breadcrum end-->
        </div>
        <!-- Table -->
        <div class="table-responsive pmd-card pmd-z-depth">
            <table id="bg_video_videotable" class="table table-mc-red pmd-table">

            </table>
        </div>
        <!-- Card Footer -->
        <div id="bg_video_pager" style="display: none;" class="pmd-card-footer">
            <ul class="pmd-pagination pull-right list-inline">
			  ...
			  <button class="btn pmd-ripple-effect pmd-btn-flat btn-link dropdown-toggle" type="button"
                      id="bg_video_tablerowsselect" data-toggle="dropdown" aria-expanded="false">10 <span
