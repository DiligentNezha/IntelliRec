...
<div class="logincard">
  <div class="pmd-card card-default pmd-z-depth">
    <div class="login-card">
      <form action="${pageContext.request.contextPath}/user/userAction_login" method="post">
        <div class="pmd-card-title card-header-border text-center">
          <div class="loginlogo">
            <a href="javascript:void(0);"><img
                    src="${pageContext.request.contextPath}/background/proadmin/themes/images/logo-icon.png" alt="Logo"></a>
          </div>
        ...
        <div class="pmd-card-body">
          ...
          <div class="form-group pmd-textfield pmd-textfield-floating-label">
            <label for="email" class="control-label pmd-input-group-label">Email</label>
            <div class="input-group">
              <div class="input-group-addon"><i class="material-icons md-dark pmd-sm">perm_identity</i></div>
              <input type="text" name="email" value="880000001@qq.com" class="form-control" id="email">
            </div>
          </div>
          ...
          <div class="form-group pmd-textfield pmd-textfield-floating-label">
            ...
            <div class="input-group">
              ...
              <input type="password" name="password" value="root" class="form-control" id="password">
            </div>
          </div>
        </div>
        <div class="pmd-card-footer card-footer-no-border card-footer-p16 text-center">
          ...
          <p class="redirection-link">Don't have an account? <a href="javascript:void(0);" class="login-register">Sign
            Up</a>. </p>
    ...
    <div class="register-card">
      <div class="pmd-card-title card-header-border text-center">
        <div class="loginlogo">
          <a href="javascript:void(0);"><img
                  src="${pageContext.request.contextPath}/background/proadmin/themes/images/logo-icon.png"
                  alt="Logo"></a>
        </div>
      ...
      <form>
        ...
        <div class="pmd-card-footer card-footer-no-border card-footer-p16 text-center">
          <a href="${pageContext.request.contextPath}/background/index.jsp" type="button"
             class="btn pmd-ripple-effect btn-primary btn-block">Sign Up</a>
          <p class="redirection-link">Already have an account? <a href="javascript:void(0);" class="register-login">Sign
            In</a>. </p>
        </div>
      </form>
    </div>
    ...
    <div class="forgot-password-card">
      <form>
        <div class="pmd-card-title card-header-border text-center">
          ...
          <h3>Forgot
            password?<br><span>Submit your email address and we'll send you a link to reset your password.</span></h3>
        </div>
        <div class="pmd-card-body">
          <div class="form-group pmd-textfield pmd-textfield-floating-label">
            <label for="inputError1" class="control-label pmd-input-group-label">Email address</label>
        ...
        <div class="pmd-card-footer card-footer-no-border card-footer-p16 text-center">
          ...
          <p class="redirection-link">Already registered? <a href="javascript:void(0);" class="register-login">Sign
            In</a></p>
        </div>
      </form>
    </div>
