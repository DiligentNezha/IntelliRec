			...
			<div class="pmd-card pmd-z-depth">      
				<div class="pmd-card-title">
					...
					<div class="media-body media-middle">
						<h2 class="pmd-card-title-text typo-fill-secondary">Recent Activities<span class="grow-up"><img src="${pageContext.request.contextPath}/background/proadmin/themes/images/grow-up-arrow.png" alt="grow-up"></span></h2>
					</div>
			...
			<div class="pmd-card pmd-z-depth recent-post">      
				...
				<ul class="list-group pmd-card-list pmd-list-avatar">
						<li class="list-group-item">
							<div class="media-left"> 
								<a href="javascript:void(0);" class="avatar-list-img" title="profile-link"> 
									<img alt="40x40" data-src="holder.js/40x40" class="img-responsive" src="${pageContext.request.contextPath}/background/proadmin/themes/images/profile-1.png" data-holder-rendered="true">
								</a> 
							</div>
							<div class="media-body media-middle">
						...
						<li class="list-group-item">
							<div class="media-left"> 
								<a href="javascript:void(0);" class="avatar-list-img" title="profile-link"> 
									<img alt="40x40" data-src="holder.js/40x40" class="img-responsive" src="${pageContext.request.contextPath}/background/proadmin/themes/images/profile-2.png" data-holder-rendered="true">
								</a> 
							</div>
							<div class="media-body media-middle">
						...
						<li class="list-group-item">
							<div class="media-left"> 
								<a href="javascript:void(0);" class="avatar-list-img" title="profile-link"> 
									<img alt="40x40" data-src="holder.js/40x40" class="img-responsive" src="${pageContext.request.contextPath}/background/proadmin/themes/images/profile-3.png" data-holder-rendered="true">
								</a> 
							</div>
							<div class="media-body media-middle">
						...
						<li class="list-group-item">
							<div class="media-left"> 
								<a href="javascript:void(0);" class="avatar-list-img" title="profile-link"> 
									<img alt="40x40" data-src="holder.js/40x40" class="img-responsive" src="${pageContext.request.contextPath}/background/proadmin/themes/images/profile-4.png" data-holder-rendered="true">
								</a> 
							</div>
							<div class="media-body media-middle">
...
<!--circle chart-->
<script src="${pageContext.request.contextPath}/background/proadmin/themes/js/circles.min.js"></script>
...
<script src="${pageContext.request.contextPath}/background/proadmin/themes/js/highcharts.js"></script>
<script src="${pageContext.request.contextPath}/background/proadmin/themes/js/highcharts-more.js"></script>
...
<script type="text/javascript" language="javascript" src="${pageContext.request.contextPath}/background/proadmin/components/datetimepicker/js/moment-with-locales.js"></script>
<script type="text/javascript" language="javascript" src="${pageContext.request.contextPath}/background/proadmin/components/datetimepicker/js/bootstrap-datetimepicker.js"></script>
<script>
