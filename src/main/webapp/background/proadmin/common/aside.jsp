    ...
    <li class="dropdown pmd-dropdown pmd-user-info visible-xs visible-md visible-sm visible-lg">
      <a aria-expanded="false" data-toggle="dropdown" class="btn-user dropdown-toggle media" data-sidebar="true" aria-expandedhref="javascript:void(0);">
        <div class="media-left">
          <img src="${userVo.headPhotoSmall}" alt="New User">
        </div>
        <div class="media-body media-middle">${userVo.userName}</div>
        <div class="media-right media-middle"><i class="dic-more-vert dic"></i></div>
      </a>
      <ul class="dropdown-menu">
        <li><a href="${pageContext.request.contextPath}/user/userAction_logout">Logout</a></li>
      </ul>
    </li><!-- End user info -->
    
    <li>
      <a class="pmd-ripple-effect" href="${pageContext.request.contextPath}/background/index.jsp">
...
<path fill="#C9C8C8" d="M6.188,0.001C5.232,0.001,4.5,0.732,4.5,1.688c0,0.394,0.166,0.739,0.334,1.02L5.45,3.71
	...
	c0,0,0.616-0.945,0.616-1.001c0.168-0.281,0.334-0.626,0.334-1.02C7.875,0.733,7.144,0.002,6.188,0.001L6.188,0.001z"/>
        ...
        <span class="media-body">用户模块</span>
        <div class="media-right media-bottom"><i class="dic-more-vert dic"></i></div>
      </a>
      <ul class="dropdown-menu">
        <li><a href="${pageContext.request.contextPath}/userManager/userManagerAction_toUserInfoManagerPage">用户信息管理</a></li>
        <li><a href="icons.jsp">Icons</a></li>
        <li><a href="shadow.jsp">Shadow</a></li>
        <li><a href="accordion.jsp">Accordion</a></li>
        <li><a href="alert.jsp">Alert</a></li>
        <li><a href="badge.jsp">Badge</a></li>
        ...
        <li><a href="progressbar.jsp">Progressbar</a></li>
        <!--<li><a href="sidebar.jsp">Sidebar</a></li> -->
        <li><a href="tab.jsp">Tab</a></li>
        <li><a href="tooltip.jsp">Tooltip</a></li>
        <li><a href="card.jsp">Card</a></li>
        <li><a href="floating-button.jsp">Floating Action Button</a></li>
      </ul>
    </li>
    <li class="dropdown pmd-dropdown">
      <a aria-expanded="false" data-toggle="dropdown" class="btn-user dropdown-toggle media" data-sidebar="true" href="javascript:void(0);">
...
<path fill="#C9C8C8" d="M0,0v18h14.187V0H0z M3.121,3.293h2.023v4.767H3.121V3.293z M11.211,14.764H2.948v-2.022h8.263V14.764
	...
	H7.455V3.207h3.756V5.229z"/>
      ...
      <ul class="dropdown-menu">
        ...
        <li><a href="form.jsp">Form Examples</a></li>
      </ul>
    </li>
    <li class="dropdown pmd-dropdown">
      <a aria-expanded="false" data-toggle="dropdown" class="btn-user dropdown-toggle media" data-sidebar="true" href="javascript:void(0);">
...
<path fill="#C9C8C8" d="M0,0v12.706h18V0H0z M12.706,4.235v3.176H9.108V4.235H12.706z M8.049,4.235v3.176h-6.99V4.235H8.049z
	...
	h-3.176V4.235h3.176V7.412L16.942,7.412z"/>
      ...
      <ul class="dropdown-menu">
        <li><a href="table.jsp">Normal Table</a></li>
        <li><a href="data-table.jsp">Data Table</a></li>
        <li><a href="table-with-expand-collapse.jsp">Table with Expand/Collapse</a></li>
      </ul>
    </li>
    ...
    <li class="dropdown pmd-dropdown">
      ...
      <ul class="dropdown-menu">
        ...
        <li><a href="blank.jsp">Blank</a></li>
        <li><a href="profile.jsp">Profile</a></li>
      </ul>
    </li>
    <li>
      <a class="pmd-ripple-effect" href="login.jsp">
        <i class="media-left media-middle">
    ...
    <li>
      <a class="pmd-ripple-effect" href="inbox.jsp">
        <i class="media-left media-middle">
    ...
    <li>
      <a class="pmd-ripple-effect" href="notifications.jsp">
        <i class="media-left media-middle">
